...
import 'package:projek_get/app/modules/update_mahasiswa/bindings/updatde_product_binding.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      ...
      page: () => const AddmahasiswaController(),
      binding: AddmahasiswaBinding(),
    ),
    GetPage(
      name: _Paths.UPDATE_PRODUCT,
      page: () => const AddmahasiswaBinding(),
